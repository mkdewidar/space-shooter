...
ObjectManager::ObjectManager(vector<GameObject*>* gameObjects, MessageBus * messageBus)
...
void ObjectManager::HandleMessage(Msg * msg)
{
	...
	if (msg->msgType == MsgTypes::CREATEOBJECT)
	{
		...
		Vector2D center = ASTEROIDPOSITIONS;
